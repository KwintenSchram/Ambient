...
S_UPPER_SRCS += \
../system/src/cmsis/startup_stm32l162xd.S 

OBJS += \
./system/src/cmsis/startup_stm32l162xd.o \
./system/src/cmsis/system_stm32l1xx.o 

S_UPPER_DEPS += \
./system/src/cmsis/startup_stm32l162xd.d 
...
system/src/cmsis/%.o: ../system/src/cmsis/%.S
	...
	arm-none-eabi-gcc -mcpu=cortex-m3 -mthumb -Og -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -fno-move-loop-invariants -Wall -Wextra  -g3 -x assembler-with-cpp -DDEBUG -DTRACE -DSTM32L162xD -I"../include" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32l1xx" -I"../system/include/cmsis/device" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -c -o "$@" "$<"
